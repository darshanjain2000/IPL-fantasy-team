...
tree = load(os.path.join(os.getcwd(), 'utilities', 'decision_model.pkl'))
...
# Batting Team
  ...
  # venue
  if venue == 'Barabati Stadium ' or 'Cuttack':
     prediction_array.append(0)
  elif venue == 'Brabourne Stadium' or 'Mumbai':
     prediction_array.append(1)
  elif venue == 'Buffalo Park'or 'East London':
     prediction_array.append(2)
  elif venue == 'De Beers Diamond Oval'or 'Kimberley':
     prediction_array.append(3)
  elif venue == 'Dr DY Patil Sports Academy' or 'Mumbai':
     prediction_array.append(4)
  elif venue == 'Dr. Y.S. Rajasekhara Reddy ACA-VDCA Cricket Stadium' or 'Visakhapatnam':
     prediction_array.append(5)
  elif venue == 'Dubai International Cricket Stadium' or 'Dubai':
     prediction_array.append(6)
  elif venue == 'Eden Gardens' or 'Kolkata':
     prediction_array.append(7)
  elif venue == 'Feroz Shah Kotla' or 'Delhi':
     prediction_array.append(8)
  elif venue == 'Green Park' or 'Kanpur':
     prediction_array.append(9)
  elif venue == 'Himachal Pradesh Cricket Association Stadium' or 'Dharamsala':
     prediction_array.append(10)
  elif venue == 'Holkar Cricket Stadium' or 'Indore':
     prediction_array.append(11)
  elif venue == 'JSCA International Stadium Complex' or 'Ranchi':
     prediction_array.append(12)
  elif venue == 'Kingsmead' or 'Durban':
     prediction_array.append(13)
  elif venue == 'M Chinnaswamy Stadium' or 'Bangalore':
     prediction_array.append(14)
  elif venue == 'M.Chinnaswamy Stadium' or 'Bangalore':
     prediction_array.append(15)
  elif venue == 'MA Chidambaram Stadium, Chepauk' or 'Chennai':
     prediction_array.append(16)
  elif venue == 'Maharashtra Cricket Association Stadium' or 'Mumbai':
     prediction_array.append(17)
  elif venue == 'Nehru Stadium' or 'Delhi':
     prediction_array.append(18)
  elif venue == 'New Wanderers Stadium' or 'Johannesburg':
     prediction_array.append(19)
  elif venue == 'Newlands' or 'Cape Town':
     prediction_array.append(20)
  elif venue == 'OUTsurance Oval' or 'Bloemfontein':
     prediction_array.append(21)
  elif venue == 'Punjab Cricket Association IS Bindra Stadium, Mohali' or 'Chandigarh':
     prediction_array.append(22)
  elif venue == 'Punjab Cricket Association Stadium, Mohali' or 'Chandigarh':
     prediction_array.append(23)
  elif venue == 'Rajiv Gandhi International Stadium, Uppal' or 'Hyderabad':
     prediction_array.append(24)
  elif venue == 'Sardar Patel Stadium, Motera' or 'Ahmedabad':
     prediction_array.append(25)
  elif venue == 'Saurashtra Cricket Association Stadium' or 'Rajkot':
     prediction_array.append(26)
  elif venue == 'Sawai Mansingh Stadium' or 'Jaipur':
     prediction_array.append(27)
  elif venue == 'Shaheed Veer Narayan Singh International Stadium' or 'Raipur':
     prediction_array.append(28)
  elif venue == 'Sharjah Cricket Stadium' or 'Sharjah':
     prediction_array.append(29)
  elif venue == 'Sheikh Zayed Stadium' or 'Abu Dhabi':
     prediction_array.append(30)
  elif venue == "St George's Park" or 'Port Elizabeth':
     prediction_array.append(31)
  elif venue == 'Subrata Roy Sahara Stadium':
     prediction_array.append(32)
  elif venue == 'SuperSport Park' or 'Centurion':
     prediction_array.append(33)
  elif venue == 'Vidarbha Cricket Association Stadium, Jamtha':
     prediction_array.append(34)
  elif venue == 'Wankhede Stadium' or 'Mumbai':
